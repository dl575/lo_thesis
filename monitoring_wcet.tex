...
%Main core and monitoring core. FIFO connects cores which can cause main core to stall if full. Separate memories (i.e. no contention).

Figure~\ref{fig:arch.model} shows the model of run-time parallel monitoring
