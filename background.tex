...
coprocessors \cite{chen08-lba, flexcore-micro10,
harmoni-dsn12}, for monitoring. Our work in this thesis is targeted at these programmable
...
Figure~\ref{fig:background.monitoring.arch} shows a model of the
