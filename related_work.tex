...
%%%%%%%%%%%%%%%%%%%%%%%%
% monitoring_hard_drop
%%%%%%%%%%%%%%%%%%%%%%%%

% Monitoring
The architecture we present in this paper is applicable to a wide range of
...
% WCET
As mentioned earlier, there is existing work for statically estimating the WCET of
